...
public final class PermitAllUrl {
     ...
     */
    private static final String[] ENDPOINTS = {"/back/img/**","/back/login-sms.html","/back/login.html","/back/css/**","/back/js/**","/login","/user/login","/actuator/health", "/actuator/env", "/actuator/metrics/**", "/actuator/trace", "/actuator/dump",
